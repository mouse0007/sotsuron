\chapter{評価手法}
\section{分散分析}
観測高さ間における室内音響物理指標や音響物理量の違いをみるため、分散分析を用いる。
分散分析とは、3群以上からなるデータの母平均の差を検定であり、

\subsection{一元配置分散分析}
要因が異なる複数の標本の母平均が等しい(複数の標本から求められた平均値が、同じ母平均を持つ母集団から抽出された)という仮説を検定することにより、要因の違いにより複数の標本の母平均に
